...
Public Class CrystalReportes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Farmacia.CrystalReportes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportes = New CrystalReportes()
        rpt.Site = Me.Site
        Return rpt
    End Function
